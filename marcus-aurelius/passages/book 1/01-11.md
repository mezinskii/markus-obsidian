...
[[fronto|Фронтону]]²⁰ — пониманием того, каковы злорадство, коварство и лицемерие, присущие тирании, и того, насколько вообще черствы душой люди, слывущие у нас аристократами.
...
**Структурное соответствие с Med. 1.16.** Тезис «патриции вообще лишены στοργή» (01-11) и развёрнутый портрет Антонина Пия (1.16), где Антонин специально хвалится как «весьма φιλόστοργος, но без слащавости», образуют осознанную пару. Общий класс — патриции — характеризуется отсутствием [[philostorgia|φιλοστοργία]]; **исключение из этого класса** — приёмный отец Марка — характеризуется как раз её наличием. Структурно: 01-11 ставит диагноз, 01-16 предъявляет единственный известный Марку контрпример. Длиннейший в Книге I портрет (1.16) занимает это место не случайно.
...
**Structural correspondence with Med. 1.16.** The thesis "patricians at large are deficient in στοργή" (01-11) and the extended portrait of Antoninus Pius (1.16), in which Antoninus is specifically praised as "very *philostorgos*, but without sweetness," form a deliberate pair. The general class — patricians — is characterised by the absence of [[philostorgia|*philostorgia*]]; the **exception to this class** — Marcus's adoptive father — is characterised precisely by its presence. Structurally: 01-11 issues the diagnosis, 01-16 produces the one known counter-example. That the longest portrait in Book I (1.16) occupies this slot is not accidental.
