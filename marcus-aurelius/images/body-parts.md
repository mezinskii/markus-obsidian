---
title_ru: Части тела — образ людей как членов единого организма
title_en: Body parts — humans as members of one organism
type: image
related_terms:
  - synergia
  - syngenes
...
In passage [[02-01]] the image works as the concluding argument: once it has been said that one's neighbour is [[syngenes|kindred]] by [[nous|reason]], the bodily image of cooperation ([[synergia]]) is brought in, and [[antiprassein|counter-action]] then turns out to be not a moral fault but a physiological disorder — as if the eyelid were to struggle with the pupil. See the kindred image [[cooperation]] and the supporting doctrine [[unity-of-cosmos]].
