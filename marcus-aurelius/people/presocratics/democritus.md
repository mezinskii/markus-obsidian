...
name_ru: Демокрит
name_en: Democritus
greek_name: Δημόκριτος ὁ Ἀβδηρίτης
latin_name: Democritus Abderita
dates_ru: ок. 460 – ок. 370 до н.э.
dates_en: c. 460 – c. 370 BCE
birthplace_ru: Абдеры (Фракия)
birthplace_en: Abdera (Thrace)
school: atomist
role_ru: создатель (вместе с Левкиппом) атомистической системы; «смеющийся философ»; для Марка — носитель главной соперничающей космологии («атомы» против «провидения»)
role_en: founder (with Leucippus) of the atomist system; the "laughing philosopher"; for Marcus the bearer of the chief rival cosmology ("atoms" versus "providence")
---

## Биография

Демокрит из Абдер — натурфилософ, вместе со своим учителем Левкиппом основатель **атомизма**. Происходил из богатой семьи; по преданию, истратил доставшееся наследство на путешествия (Египет, Вавилон, Персия, возможно Индия) ради знания. Чрезвычайно плодовитый автор (Фрасилл сгруппировал его сочинения по тетралогиям, как Платона), но почти всё утрачено — сохранились лишь фрагменты, преимущественно этические. Прозван «смеющимся философом» — в позднейшей традиции его противопоставляли «плачущему» [[heraclitus|Гераклиту]].

Главный биографический источник — Диоген Лаэртский IX 34–49. О смерти существуют разные версии, и Роговин в примечании к [[03-03]] обе называет: по Диогену Лаэртскому, Демокрит умер от глубокой старости (дожив, по некоторым данным, до ста с лишним лет); по Лукрецию (*De rer. nat.* III 1039–1041), он сам прервал жизнь, почувствовав приближение старческого слабоумия. Марк же даёт фольклорно-сниженную версию: его «заели вши» (φθεῖρες).

## Biography

Democritus of Abdera was a natural philosopher, founder — together with his teacher Leucippus — of **atomism**. He came from a wealthy family and, by tradition, spent his inheritance on travels (Egypt, Babylon, Persia, perhaps India) in the pursuit of knowledge. An extraordinarily prolific author (Thrasyllus grouped his works into tetralogies, as he did Plato's), but almost all is lost — only fragments survive, chiefly ethical. He was nicknamed the "laughing philosopher" — in the later tradition he was set against the "weeping" [[heraclitus|Heraclitus]].
...
**Атомизм.** Реальность состоит из бесконечного множества неделимых телец — **атомов** (ἄτομα, «неразрезаемые»), различающихся формой, порядком и положением, — движущихся в **пустоте** (κενόν). Возникновение и гибель вещей — лишь соединение и разъединение атомов; качества (цвет, вкус, тепло) существуют «по установлению» (νόμῳ), а «по истине» (ἐτεῇ) есть только атомы и пустота. Космосы возникают из вихрей атомов **без замысла и цели** — чистая механическая необходимость, без [[pronoia|провидения]].

**Этика.** Цель жизни — **εὐθυμία** (благое расположение духа, «доброе самочувствие»), достигаемая мерой и невозмутимостью; предвестие эпикурейской ἀταραξία и стоической [[apatheia|απатии]].

**Почему важен для Марка.** Демокритов (и наследующий ему эпикуров) атомизм — **главная соперничающая космология** стоическому провидению. Отсюда повторяющаяся у Марка развилка: **ἤτοι πρόνοια ἢ ἄτομοι** — «либо провидение, либо атомы». Марк раз за разом ставит читателя перед этим выбором: упорядоченный, разумный, провиденциальный космос Стои — или слепое скопление атомов Демокрита. Знаменательно, что Марк не всегда «закрывает» дилемму силой: иногда он показывает, что **даже на атомистическом допущении** стоический этический вывод (принимай происходящее, держись своего разума) остаётся в силе. Так Демокрит для Марка — не просто заблуждающийся, а постоянный мысленный оппонент, проверяющий прочность стоической позиции.
...
**Ethics.** The goal of life is **εὐθυμία** (good cheer, "well-being of soul"), attained through measure and equanimity; a forerunner of Epicurean ἀταραξία and Stoic [[apatheia|apatheia]].
