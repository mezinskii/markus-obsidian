...
name_ru: Диогнет
name_en: Diognetus
greek_name: Διόγνητος
latin_name: Diognetus
dates_ru: I/II в. н.э. (точные даты неизвестны; вероятно активен в 130-х гг.)
dates_en: late 1st / early 2nd century CE (exact dates unknown; probably active in the 130s)
...
2. **Med. 1.6** ([[01-06]]) — Marcus ascribes to him a series of virtues bound up with philosophical initiation: scepticism toward charlatanism, openness to παρρησία, οἰκείωσις with philosophy, a list of further teachers ([[bacchius|Bacchius]], [[tandasis|Tandasis]], [[marcianus|Marcianus]]), the writing of adolescent dialogues, the Greek asceticism.
...
1. **Epistemic clearing** — teaching how to distinguish philosophy from wonder-working, charlatanism, magic; and from light passionate enthusiasms (such as the quail-sport).
2. **Ethical openness** — teaching the reception of παρρησία from others, the refusal to close off before criticism; and being-made-one's-own (οἰκειωθῆναι) for the philosophical tradition.
3. **Practical initiation** — direction to the next teachers ([[bacchius|Bacchius]], [[tandasis|Tandasis]], [[marcianus|Marcianus]]), the instruction to write one's own dialogues, the adoption of the Greek asceticism (σκίμπους + δορά + the philosopher's cloak).
...
- **SHA *Marcus* 4.9** — единственное прямое биографическое свидетельство.
