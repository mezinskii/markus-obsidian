...
source:
  ...
  section: 94 PLM
  note: >-
    archive.org, текстовый слой издания Бэренса, Poetae Latini Minores, т. IV, «Petronii 94» — печатная с. 97. Ссылка карточки («94 PLM») подтвердилась буквально. Приведён весь фрагмент, шесть строк, три элегических дистиха; английский передаёт только строки 3-6 — то, что заключено в кавычки. Строки 1-2 — рамка, обращение к Делии, сестре Феба, с просьбой отнести слова брату; в переводе их нет. Кавычки внутри принадлежат Бэренсу. Согласный u нормализован в v
occasion:
deities:
  - Apollo
  - Diana
...
Если ты сестра Феба, поручаю тебе, Делия, дело:
отнеси, стало быть, брату слова, о которых прошу:
«Из сицилийского мрамора я воздвиг тебе, Дельфиец, храм
и под лёгкие тростники сложил тебе светлые речи.
Теперь, если ты нас слышишь и впрямь божествен, Аполлон,
скажи мне: у кого нет денег — откуда ему их взять?»
