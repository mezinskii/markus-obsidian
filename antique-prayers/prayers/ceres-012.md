---
sanity_id: prayer-prayer-ceres-012
prayer_id: prayer_ceres_012
slug: prayer-ceres-012
title:
  en: "Prayer to Ceres"
  ru: "Молитва Церере"
culture: roman
...
original_lang:
source:
  author: M. Horatius Piscinus
  work: Harvest Prayer to Ceres (modern reconstruction)
  section:
occasion: harvest
deities:
  - Ceres
...
О святейшая Церера, кормилица-Мать, чьё священное чрево породило и богов, и людей; ты, Вервактор, что первым впряг быков и приставил лемех к нетронутой почве; ты, Репаратор, что первым проложил борозды на залежи; ты, Импорцитор, что первым сделал наши борозды широкими; ты, Инситор, что первым бросил свою щедрость на землю и научил семя расти; Обаратор, Сарритор, Субрунцинатор — и ты, Стеркулиния, что первой позаботилась о всходах; ты, Флора, что даёшь зерну плодоносить; ты, Месситор, что первым приставил серп к колосьям; ты, Конвектор, что первым разостлал зерно на священном току; ты, Нодутерент, что первым показал нам, как молотить, — и ты, святейшая Церера, чьё самое дыхание отделяет белую мякину от золотого зерна; вы, Кондитор и Тутилина, что стережёте зерно в закромах; ты, Промитор, что первым смолол зерно и раздал муку на насущный хлеб; ты, вечная спасительница Церера, изливающая щедроты твои на меня и на моих, — тебе, русая Церера, радостно воздаю благодарность и хвалу и от малого, что имею, охотно приношу тебе жертву. Прими это, первые плоды полей моих. Пусть приношение моё склонит тебя ко мне. Питай всегда меня и моих щедротами твоими, о святейшая и питающая Мать, кроткая Церера.
