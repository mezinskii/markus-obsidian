---
sanity_id: prayer-prayer-bacchus-001
prayer_id: prayer_bacchus_001
slug: prayer-bacchus-001
culture: roman
form: ritual
period:
provenance: unclear
...
source:
  ...
  section:
  note: >-
    archive.org, текстовый слой издания Бэренса, Fragmenta Poetarum Romanorum (1886), Цезий Басс, incertae sedis, фрагмент 2 — печатная с. 364. Первоисточник указан там же: Цезий Басс, «О метрах», с. 255 по изданию Кейля, где эти строки приведены как образец ИТИФАЛЛИЧЕСКОГО размера; те же строки цитируют Диомед (с. 511 К.), Марий Викторин (с. 92 и 118 К.) и Теренциан Мавр (ст. 2594). Согласный u нормализован в v («uiridis»). ВНИМАНИЕ, конъектуры Бэренса против рукописей: строка 4 «ac te» (рукописи «apte»), строка 6 «et e» (рукописи «te»), строка 7 «armet» — по Марию Викторину, в рукописях Цезия «arma et». Начало у Диомеда «Lyaee», в рукописях Цезия «o Lyaee». Сам Бэренс оговаривает, что неизвестно, сочинил ли эти стихи Цезий Басс, перевёл ли, или взял у более ранних поэтов — отсюда и разнобой в атрибуции карточки
occasion:
deities:
  - Bacchus
sphere:
...
Приди сюда, Лиэй,
Бассарей двурогий,
Менальский, двуматерний,
с блестящими кудрями; и пусть
плющ с золотыми гроздьями
и зелёное древко,
снятое с венков, тебя уберут;
приди с миром к алтарям,
Вакх, Вакх, Вакх!
