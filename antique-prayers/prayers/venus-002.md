...
source:
  ...
  section: 1.30.1-8
  note: >-
    thelatinlibrary.com, Horatius Carmina I.30.1-8 (ода целиком)
occasion:
deities:
  - Venus
sphere:
...
О Венера, царица Книда и Пафоса,
презри любезный тебе Кипр и в изящный храм
Гликеры, что зовёт тебя обильным ладаном,
перенесись.
Пусть с тобою поспешат пылкий мальчик,
и Грации с распущенными поясами, и Нимфы,
и без тебя мало приветливая Юность,
и Меркурий.
...
Восемь строк — ода целиком, и целиком же клетический гимн: тот разряд, где божество не просят о милости, а вызывают с места.
...
Eight lines — the whole ode, and wholly a kletic hymn: the class in which a deity is not asked for a favour but summoned away from somewhere.
