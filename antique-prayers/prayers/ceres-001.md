---
sanity_id: prayer-prayer-ceres-001
prayer_id: prayer_ceres_001
slug: prayer-ceres-001
culture: roman
form: ritual
period: Augustan
provenance: ancient
...
source:
  ...
  section: '1.338-350'
  note: >-
    thelatinlibrary.com, Vergilius Georgica I.338-350. ИСПРАВЛЕНО СОЧИНЕНИЕ: в карточке значились «Буколики», но это «Георгики»; u приведено к v
...
Прежде всего чти богов и великой Церере
приноси ежегодные жертвы, свершая обряд на весёлых травах
на исходе последней зимы, когда весна уже ясна.
Тогда жирны ягнята, тогда мягче всего вина,
тогда сладки сны и густы тени в горах.
Пусть вся сельская молодёжь у тебя поклоняется Церере:
ей раствори соты молоком и кротким Вакхом,
и трижды пусть обойдёт вокруг новых всходов счастливая жертва,
и пусть весь хор и товарищи с ликованием ей сопутствуют
и криком зовут Цереру под кров; и пусть никто прежде
не подставит серпа под созревшие колосья,
чем, увив виски плетёным дубом, Церере
он спляшет нескладную пляску и произнесёт песни.
