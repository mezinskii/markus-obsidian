---
sanity_id: prayer-prayer-ceres-007
prayer_id: prayer_ceres_007
slug: prayer-ceres-007
culture: roman
form: literary
period: 3rd c. BC
provenance: ancient
...
source:
  ...
  section:
  note: >-
    archive.org, текстовый слой издания Риббека, Tragicorum Romanorum Fragmenta (1871), Ливий Андроник, «Троянский конь» (EQVOS TROIANVS), строки 219-221 сплошной нумерации Риббека — печатная с. 31. Метрические знаки ударения, которыми Риббек размечает стих, сняты; исправлен огрех OCR «quaa» → «quas». ВНИМАНИЕ: в самом фрагменте божество НЕ НАЗВАНО — это три строки из утраченной трагедии, и к кому они обращены, неизвестно. Отнесение к Церере в карточке ниоткуда из текста не следует. Отсюда же, по-видимому, взята и латынь новодельной carmenta-010, где на место «mihi» подставлено «illi, Carmentis»
occasion:
deities:
  - Ceres
sphere:
...
о которых прошу, о которых молю:
протяни, пособи!
