...
Оборот «sic… ut» здесь не украшение, а обиходная латинская форма обета: «пусть тебе будет то-то, как ты сделаешь для меня то-то». Эпиграмма пользуется настоящей молитвенной конструкцией, наполняя её содержанием из скандальной хроники Олимпа.

В карточке значилась строка 5.7.5; приведены строки 5-8, то есть мольба целиком.
...
The sic … ut turn is not ornament but the everyday Latin form of a vow: "so may such a thing befall you, as you do such a thing for me". The epigram uses a real prayer construction and fills it with material from the scandal columns of Olympus.

The card cited 5.7.5; lines 5-8 are given, that is, the whole plea.
